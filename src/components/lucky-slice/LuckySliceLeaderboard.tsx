...
import { useLuckySliceLeaderboard } from "@/hooks/useLuckySliceLeaderboard";
...
export default function LuckySliceLeaderboard() {
  const { publicKey } = useWallet();
  const { entries, loading, error } = useLuckySliceLeaderboard();
